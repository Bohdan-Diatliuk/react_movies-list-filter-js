...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://bohdan-diatliuk.github.io/react_movies-list-filter-js/) and add it to the PR description.
